...
Downloaded the program, install the following libraries through Arduino's IDE (possible with the latest updated version of the IDE):
"Liquidcrystal_i2c.h"
"Keypad.h"
"Servo.h"
...
The program works on the Extreme Power Tracker project, which manages a solar pursuer allowing them to chase the sun via photoresistors.
